// Dev-environment rpath for this crate's fuzz binary (it transitively links the vendored build-tree
// llama.cpp dylibs via hydra-worker → hydra-engine-sys). A build script's -rpath link-arg does
