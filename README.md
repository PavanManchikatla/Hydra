...
| Loss of the FINAL stage in the two-stage relayed (D0) topology | `hydra-coordinator` | none yet — the survivor cannot re-emit position 0's activation; a spec decision is escalated (PROJECT_STATE §7.80) | **⛔ escalated; library claim only via D1 (`three_node_recovery.rs`)** |
